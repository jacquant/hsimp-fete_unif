!function (e) {
    ...
    return function e(a, r, o) {
        ...
        1: [function (e, a, r) {
            ...
            "use strict";
            var o = e("hsimp-library"), n = {}, i = o.prop(0), s = o.prop(1), t = function (e) {
                var a = {}, r = 0, t = [];
        ...
        }, {"hsimp-library": 10}], 3: [function (e, a, r) {
            a.exports = {
                common: {
                ...
                xkcd: {name: "xkcd", message: "I suspect the password crackers might be on to this one by now..."},
                jeff: {
                ...
                lengthVeryShort: {
                    ...
                    message: "Your password is very very short. The longer a password is the more secure it will be."
                },
                possiblyWord: {
                ...
                lengthLong: {name: "Length: Long", message: "Your password is over sixteen characters long."}
            }
        }, {}], 4: [function (e, a, r) {
            "use strict";
            var o, n = e("hsimp-library"), i = [], s = function (e) {
                ...
                var a, r = {}, i = ["highlight", "insecure", "warning", "achievement", "notice"];
        ...
        }, {"hsimp-library": 10}], 5: [function (e, a, r) {
            "use strict";
            var o = e("hsimp-library"), n = function (e) {
            ...
            a.exports = n
        }, {"hsimp-library": 10}], 6: [function (e, a, r) {
            "use strict";
            var o = e("hsimp-library"), n = e("../check");
            a.exports = n(function (e) {
                return [function (a) {
                    var r;
                    return a = a.toLowerCase(), o.forEach(function (e, o) {
                        if (e === a) return r = 5 * Math.ceil((o + 1) / 5), !1
                    }, e), !!r && {level: "insecure", id: "common", value: r}
                }]
            })
        }, {"../check": 5, "hsimp-library": 10}], 7: [function (e, a, r) {
            "use strict";
            var o = e("hsimp-library"), n = e("../check");
            a.exports = n(function (e) {
        ...
        }, {"../check": 5, "hsimp-library": 10}], 8: [function (e, a, r) {
            a.exports = {
                "^correcthorsebatterystaple$": {level: "insecure", id: "xkcd"},
            ...
            var o = function (e) {
                ...
                if (a = a || [], e = e || n, s(a)) for (r = 0, o = a.length; r < o && !1 !== e(a[r], r); r++) ; else for (r in a) if (a.hasOwnProperty(r) && !1 === e(a[r], r)) break
            }), m = function (e, a) {
            ...
            a.exports = function (a) {
                var r = e("./dictionary"), o = e("hsimp-period/period-dictionary"),
                    n = e("hsimp-named-number/named-number-dictionary"), i = e("hsimp-checker/checker-dictionary");
                ...
                var s = e("hsimp-checks/checks/patterns"), t = e("hsimp-checks/checks/common");
            ...
            "use strict";
            var o = e("hsimp-library"), n = null, i = {
                characterSets: e("hsimp-character-sets"),
                period: e("hsimp-period"),
                namedNumber: e("hsimp-named-number"),
                checker: e("hsimp-checker")
            }, s = {calculationsPerSecond: 1e10, good: 315576e8, ok: 31557600}, t = {}, l = o.memoize(function (e) {
                if (!n) throw new Error("hsimp: dictionary not set");
                var a = {}, r = i.characterSets(e), s = r.getPossibleCharacters(), l = Math.pow(s, e.length),
                    c = l / t.calculationsPerSecond;
                try {
                    var d = i.period(c), m = d.getLength(), u = i.namedNumber(m).getName(),
                        h = "1" === u ? d.getSingular() : d.getPlural(), g = u + " " + h
                } catch (e) {
                    var g = n.forever
                }
                var p = i.checker(e), b = p.getChecks();
            ...
            "use strict";
            var o, n, i = e("hsimp-library"), s = i.prop(0), t = i.prop(1), l = function (e) {
                var a = e.toExponential(), r = a.match(/^([\.\d]+)e([\+\-]\d+)/), o = e, n = 0;
                return r && r.length >= 3 && (o = +r[1], n = +r[2]), {significand: o, exponent: n}
            }, c = function (e) {
                ...
                var r = [], o = n[0], c = i.forEach(function (e) {
                    if (a < t(e)) return !1;
                    o = e
                });
                if (a < 0) return u(e, a);
                ...
                var d = l(e), h = d.significand, g = d.exponent;
                return r.unshift(m(h.toString(), g)), r.join(" ")
            }, p = function (e) {
                var a, r, n, s, t = {};
                if (!o) throw new Error("Named Number dictionary not set");
                if (i.isString(e) && (e = h(e)), !i.isNumber(e) || isNaN(e)) throw{type: "invalidNumber", value: e};
        ...
        }, {"hsimp-library": 10}], 16: [function (e, a, r) {
            a.exports = [{singular: "yoctosecond", plural: "yoctoseconds", seconds: 1e-24}, {
            ...
            "use strict";
            var o, n, i = e("hsimp-library"), s = i.prop("seconds"), t = "second", l = function (e) {
                return 1 === e.seconds
            }, c = function (e) {
        ...
        }, {"hsimp-library": 10}], 18: [function (e, a, r) {
            "use strict";
            var o = e("hsimp-main/bootstrap")(e("hsimp-main")), n = e("hsimp-library"), i = n.curry(function (e, a) {
                ...
                a.setAttribute("class", r), o.setOptions(t), a.addEventListener("keyup", function () {
                    var e = o(a.value);
                    a.value.length ? (a.setAttribute("class", "password-input"), i(e.getString(), a), s(e.getChecks(), a)) : (a.setAttribute("class", r), i(!1, a), s([]))
                })
            });
